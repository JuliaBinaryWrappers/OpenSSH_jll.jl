...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OpenSSH_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9bd350c2-7e96-507f-8002-3f2e150b4e1b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OpenSSH", artifacts_toml) for e in artifacts["OpenSSH"]]
...
if best_platform === nothing
    @debug("Unable to load OpenSSH; unsupported platform $(triplet(platform_key_abi()))")
else
